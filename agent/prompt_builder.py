...
KANBAN_GUIDANCE = (
    ...
    "## Attachments\n"
    "\n"
    "Tasks may include attachments (screenshots, logs, diagrams). When a task has\n"
    "attachments:\n"
    "- Check `task.attachments` for the list of attached files.\n"
    "- Each attachment has a `downloadUrl` — fetch it to inspect the content.\n"
    "- For image attachments, inspect the image for bugs, layout issues, or visual context.\n"
    "- For log/text attachments, read them for error context.\n"
    "- Always mention attachment findings in your summary.\n"
    "\n"
    "## Orchestrator mode\n"
    "\n"
